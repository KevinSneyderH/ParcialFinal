...
public class GUIManual extends JFrame {
    ...
    private void accionSesion() {
        ...
        usuarioCampo.setPreferredSize((new java.awt.Dimension(10, 10)));
        JTextField contraCampo = new JTextField();
        contraCampo.setPreferredSize((new java.awt.Dimension(10, 10)));
        
        JButton confirmarInicio = new JButton();
        confirmarInicio.setText("Iniciar Sesion");
        
        String usuarios[][] = seleccionDAO.getBusquedaUsuarios();
        
        confirmarInicio.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                
if(usuarioCampo.getText().equals(usuarios[0][0])&& contraCampo.getText().equals(usuarios[0][1]) ){
    ...
    haySesion = true;
                ...
                if(!haySesion){
                    ...
                    JOptionPane.showMessageDialog(null, "Bienvenido "+usuarios[0][0]+"!");
                    accionHome();
                } 
            }
        });
        ...
        sesion.add(Usuario);
        sesion.add(usuarioCampo);
        sesion.add(Contraseña);
        sesion.add(contraCampo);
        sesion.add(confirmarInicio);
